...
export const experiences = [
  {
    ...
    name: 'Todos Comemos',
    description: [
      "Architected and maintained the company's core systems across the entire technology stack, ensuring robust system reliability and driving iterative optimizations.",
      ...
      'Developed a synchronization system connecting Shopify with TC infrastructure, completely automating the sales registry process and significantly improving team efficiency.',
    ],
  },
  {
    id: crypto.randomUUID(),
    ...
    name: 'Freelances Projects',
    description: [
      'Engineered a full-stack bilingual web application, taking full ownership of the architecture from a high-performance frontend to a scalable Laravel and PHP-based REST API and internal CMS.',
      //'Built a complex memorial website using only HTML, CSS and vanilla JavaScript with custom animations',
      'Architected and deployed an e-commerce platform leveraging WordPress and WooCommerce, seamlessly integrating Mercado Pago for secure payment processing.',
